module med_phases_prep_ocn_mod
  ...
  private :: med_phases_prep_ocn_enthalpy_med_computation
  private :: med_phases_prep_ocn_enthalpy_atm_computation
...
!-----------------------------------------------------------------------------
  ...
  subroutine med_phases_prep_ocn_accum(gcomp, rc)
    ...
    if (trim(coupling_mode) == 'cesm') then
       call med_phases_prep_ocn_enthalpy_med_computation(gcomp, rc)
       if (ChkErr(rc,__LINE__,u_FILE_u)) return
    end if
    ...
    if (trim(coupling_mode) == 'noresm') then
       call med_phases_prep_ocn_enthalpy_atm_computation(gcomp, rc)
       if (ChkErr(rc,__LINE__,u_FILE_u)) return
    end if
  ...
  !-----------------------------------------------------------------------------
  subroutine med_phases_prep_ocn_enthalpy_med_computation(gcomp, rc)
    ...
    character(len=*), parameter :: subname='(med_phases_prep_ocn_enthalpy_med_computation)'
    !---------------------------------------
  ...
  end subroutine med_phases_prep_ocn_enthalpy_med_computation

  !-----------------------------------------------------------------------------
  subroutine med_phases_prep_ocn_enthalpy_atm_computation(gcomp, rc)
    ...
    character(len=*), parameter :: subname='(med_phases_prep_ocn_enthalpy_atm_computation)'
    !---------------------------------------
  ...
  end subroutine med_phases_prep_ocn_enthalpy_atm_computation
